...
<div class="logo-container">
  ...
  <!-- ========================= -->
  <form action="../src/alterarDadosUsuario.php" method="post" class="form-agendamento" onsubmit="return false;">

    <!-- Alterar Nome -->
    <div class="campo campo-icone">
      <input id="nomeUsuario" type="text" name="name" value="<?= $_SESSION['nome']; ?>" required>
    ...
    <div class="campo">
        <button onclick="window.location.href = 'coletor.php'">Torne-se um coletor</button>
    </div>
  </form>
